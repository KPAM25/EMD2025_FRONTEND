...
const columns: ColumnDef<Persona>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link href={`/recepcion/personas/${persona.idPersona}`}>
...
export default function RecepcionPersonasPage() {
  ...
  return (
    <div className='flex flex-col gap-5'>
      <div className='flex items-center justify-between'>
        <HeaderPageComponent title='Personas - Recepción' />
        <Link href='/recepcion/personas/nueva'>
          <Button>
